...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',address='$address' where userEmail='".$_SESSION['login']."'");
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',address='$address' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
if($userphoto==""):
?>
<img src="userimages/noimage.png" width="256" height="256" align="" >
    <br>
